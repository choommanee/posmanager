...
class Main extends MY_Shop_Controller
{
    ...
    function index() {
        ...
        $category_slug = 'Consumption';
        $filters =  array('query' => $this->input->post('query'),
                          'category' => array('id'=>1),
                          'subcategory' => NULL,
                          'brand' =>  NULL,
                          'sorting' =>  NULL,
                          ...
                          'page' => 1,);
                        //  print_r($filters);
        $this->data['cat1'] = $this->shop_model->getProducts2($filters);
        $filters2 =  array('query' => $this->input->post('query'),
                          'category' => array('id'=>2),
                          'subcategory' => NULL,
                          'brand' =>  NULL,
                          'sorting' =>  NULL,
                          ...
                          'page' => 1,);
                        //  print_r($filters);
        $this->data['cat2'] = $this->shop_model->getProducts2($filters2);

        $filters3 =  array('query' => $this->input->post('query'),
                          'category' => array('id'=>3),
                          'subcategory' => NULL,
                          'brand' =>  NULL,
                          'sorting' =>  NULL,
                          ...
                          'page' => 1,);
                        //  print_r($filters);
        $this->data['cat3'] = $this->shop_model->getProducts2($filters3);

        $filters4 =  array('query' => $this->input->post('query'),
                          'category' => array('id'=>4),
                          'subcategory' => NULL,
                          'brand' =>  NULL,
                          'sorting' =>  NULL,
                          ...
                          'page' => 1,);
                        //  print_r($filters);
        $this->data['cat4'] = $this->shop_model->getProducts2($filters4);
    ...
    function register() {
        ...
        if ($this->form_validation->run('') == true) {
            ...
            $company_data = [
                ...
                'group_id' => 3,
                'group_name' => 'customer',
                'customer_group_id' =>$customer_group ? $customer_group->id : NULL,
                'customer_group_name' => $customer_group ? $customer_group->name : NULL,
                'price_group_id' =>$price_group ? $price_group->id : NULL,
                'price_group_name' => $price_group ? $price_group->name : NULL,
            ];
