...
class Receipt extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->admin_model('receipt_model');
    ...
    public function index($warehouse_id = null)
    {
        ...
        $this->page_construct('Receipt/index', $meta, $this->data);
    }

    public function getReceipt($warehouse_id = null)
    {
        ...
        $detail_link = anchor('admin/receipt/view/$1', '<i class="fa fa-file-text-o"></i> รายละเอียดใบเสร็จ');
        $edit_link = anchor('admin/receipt/edit/$1', '<i class="fa fa-edit"></i> แก้ไขใบเสร็จรับเงิน', 'class="sledit"');
         $delete_link = "<a href='#' class='po' title='<b>ยกเลิกใบเสร็จรับเงิน</b>' data-content=\"<p>"
        . lang('r_u_sure') . "</p><a class='btn btn-danger invoice-delete' href='" . admin_url('receipt/delete/$1') . "'>"
        . lang('i_m_sure') . "</a> <button class='btn po-close'>" . lang('no') . "</button>\"  rel='popover'><i class=\"fa fa-trash-o\"></i> 
        ยกเลิกใบเสร็จรับเงิน</a>";
