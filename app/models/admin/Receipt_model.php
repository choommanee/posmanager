...
class Receipt_model extends CI_Model
{
    ...
    public function addReceipt($data = array(), $items = array())
    {
    ...
    public function updateReceipt($id, $data, $items = array())
    {
    ...
    public function getAllReceiptItems($sale_id, $return_id = NULL)
    {
    ...
    public function deleteReceipt($invId){
       // echo $invId;
        $Olditems = $this->getAllReceiptItems($invId);
        //print_r($Olditems);
            foreach ($Olditems as $item) {
                //  print_r($item);
                $this->db->update('sales', array('invoice_id' => "",'invoice_refference_no'=>""), array('id' => $item->sl_id));
