        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <input name="reduce_point" type="checkbox" class="checkbox" id="reduce_point" value="" <?= isset($_POST['reduce_point']) ? 'checked="checked"' : '' ?>/>
                        <label for="reduce_point" class="padding05">ใช่แต้มลดราคาได้</label>
                    </div>
                    <div class="form-group">
