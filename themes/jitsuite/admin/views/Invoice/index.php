...
<script>
    $(document).ready(function () {
        oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=admin_url('invoice/getInvoices' . ($warehouse_id ? '/' . $warehouse_id : '') .'?v=1'. ($this->input->get('shop') ? '&shop='.$this->input->get('shop') : ''). ($this->input->get('attachment') ? '&attachment='.$this->input->get('attachment') : ''). ($this->input->get('delivery') ? '&delivery='.$this->input->get('delivery') : '')); ?>',
...
<?php if ($Owner || $GP['bulk_actions']) {
	    echo admin_form_open('invoice/invoice_actions', 'id="action-form"');
	}
?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                ...
                <?php
                    echo lang('invoices') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';
                ?>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?=admin_url('invoice/add') ?>">
                                <i class="fa fa-plus-circle"></i> <?=lang('add_invoice')?>
                            </a>
                        </li>
                        <li>
