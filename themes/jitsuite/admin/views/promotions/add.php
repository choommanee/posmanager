...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('pro_id', '<?= $this->input->post('pro_id'); ?>');
        localStorage.setItem('pro_code', '<?= $this->input->post('pro_code'); ?>');
        localStorage.setItem('pro_name', '<?= $this->input->post('pro_name'); ?>');
        localStorage.setItem('pro_total_qty', '<?= $this->input->post('pro_total_qty'); ?>');
        localStorage.setItem('pro_start_date', '<?= $this->input->post('pro_start_date'); ?>');
        localStorage.setItem('pro_end_date', '<?= $this->input->post('pro_end_date'); ?>');
        localStorage.setItem('pro_type', '<?= ($this->input->post('pro_type'))?$this->input->post('pro_type'):0; ?>');
        localStorage.setItem('promotionitems', JSON.stringify(<?= $promotions_items; ?>));
        localStorage.setItem('remove_proItem', '1');
        <?php } ?>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("promotion/add/", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("date", "qadate"); ?>
                                    <?php echo form_input('pro_date', (isset($_POST['pro_date']) ? $_POST['pro_date'] : SiteHelpers::CurrentDateToThai()), 'class="form-control input-tip " id="prodate" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('pro_code', (isset($_POST['pro_code']) ? $_POST['pro_code'] : "AutoRunning"), 'class="form-control input-tip" id="pro_code"' ); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= "วันที่เริ่มต้น"; ?>
                                <?php echo form_input('pro_start_date', (isset($_POST['pro_start_date']) ? $_POST['pro_start_date'] : SiteHelpers::CurrentDateToThai()), 'class="form-control input-tip" id="pro_start_date"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= "วันที่สิ้นสุด"; ?>
                                <?php echo form_input('pro_end_date', (isset($_POST['pro_end_date']) ? $_POST['pro_end_date'] : SiteHelpers::CurrentDateToThai()), 'class="form-control input-tip" id="pro_end_date"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
