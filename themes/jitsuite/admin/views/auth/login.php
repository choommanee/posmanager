                    ...
                    <div class="login-content">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="textbox-wrap form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                    <select id="db_Selection" name="db_Selection" class="form-control " placeholder="กรุณาเลือกบริษัท">
                                        <?php
                                        foreach ($dataBaseALl as $DBkey => $DBvalue){
                                            echo "<option value='{$DBkey}'>{$DBvalue['site_name']}</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
