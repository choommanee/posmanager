            ...
            <div class="table-responsive">
                <table class="table table-bordered" style="font-size: 10px;">
                    ...
                    foreach ($rows as $row):
                        ?>
                        <tr>
                            <td style="text-align:center; width:40px; vertical-align:top;font-size: 8pt;"><?= $this->sma->ConvertDateDbToThai($row->date) ?></td>
                            ...
                            <td style="vertical-align:top;font-size: 8pt;text-align:right;">
                                <?= $this->sma->formatDecimalMoney($row->grand_total,2); ?>
                            </td>
                            <td style="vertical-align:top;font-size: 8pt;text-align:right;
                                <?php if($row->grand_total <> $row->paid){ ?>
                                    color: red;
                               <? } ?>
                            ">
                                <?= $this->sma->formatDecimalMoney($row->paid,2); ?>
                            </td>

                            <td style="vertical-align:top;font-size: 8pt;text-align:right;">
                                <?php $created_by =$this->site->getUser($row->created_by);?>
                        ...
                        $totalPerPageAmount = $totalPerPageAmount+$row->grand_total;
                        $totalpaidPerPage = $totalTaxPerPage+$row->paid;
                       // $k=$i;
                    ...
                    <tr>
                        ...
                        ?>
                        <td style="text-align:right; padding-right:10px;font-size: 8pt;"><b><?= $this->sma->formatDecimalMoney($totalpaid,2); ?></b></td>
                    </tr>
                    <td>  </td>
                    <td>  </td>
                    </tfoot>
