...
<script>
    $(document).ready(function () {
        function spb(x) {
            v = x.split('__');
            return '<strong>'+formatMoney(v[1])+'</strong>';
        }
        oTable = $('#PrRData').dataTable({
            ...
            "aoColumns": [null, null, {"mRender": currencyFormat} ,{"mRender": spb},{"mRender": currencyFormat}, {"mRender": spb}, {"mRender": currencyFormat}, {"mRender": currencyFormat},{"mRender": currencyFormat}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var pq = 0, sq = 0, bq = 0, pa = 0, sa = 0, ba = 0, pl = 0,qtyP=0,qtyS=0,qtySP=0;
                for (var i = 0; i < aaData.length; i++) {
                    qtyP +=parseFloat(aaData[aiDisplay[i]][2]);
                    qtyS +=parseFloat(aaData[aiDisplay[i]][4]);
                    qtySP +=parseFloat(aaData[aiDisplay[i]][6]);
                ...
                nCells[2].innerHTML = '<div class="text-right">'+formatMoney(qtyP)+'</div>';
                nCells[3].innerHTML = '<div class="text-right">'+formatMoney(pa)+'</div>';
                nCells[4].innerHTML = '<div class="text-right">'+formatMoney(qtyS)+'</div>';
                nCells[5].innerHTML = '<div class="text-right">'+formatMoney(sa)+'</div>';
                nCells[6].innerHTML = '<div class="text-right">'+formatMoney(qtySP)+'</div>';
                nCells[7].innerHTML = formatMoney(ba);
                nCells[8].innerHTML = '<div class="text-right"> '+formatMoney(bq)+'</div>';
            }
