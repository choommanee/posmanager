...
<?php
$wm = array('0' => lang('no_true'), '1' => lang('yes'));
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php
                                    $re_opts = array(0 => lang('no_true').', '.lang('i_ll_remove'), 1 => lang('yes').', '.lang('remove_automatically'));
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php
                                    $opt = array(1 => lang('yes'), 0 => lang('no_true'));
