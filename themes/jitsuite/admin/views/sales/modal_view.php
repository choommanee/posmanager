...
<div class="modal-dialog modal-lg no-modal-header">
    <div class="modal-content" style="font-size: 10px;">
        ...
        <div class="modal-body">
            ...
            <script>PDFObject.embed("<?= admin_url('sales/pdf/' . $inv->id)."?sale_type=".$this->input->get('sale_type'); ?>", "#pdf");</script>
...
<script type="text/javascript">
    $(document).ready( function() {
        ...
        $('.bntChangePDF').click(function () {
            ...
            if(changeType==1){
               // alert(changeType);
                PDFObject.embed("<?= admin_url('sales/pdf/' . $inv->id)."?sale_type=".$this->input->get('sale_type').'&pepperType=1'; ?>", "#pdf");
                changeType=2;
            }else if(changeType==2){
                //alert(changeType);
                PDFObject.embed("<?= admin_url('sales/pdf/' . $inv->id)."?sale_type=".$this->input->get('sale_type').'&pepperType=2'; ?>", "#pdf");
                changeType =1;
            }
