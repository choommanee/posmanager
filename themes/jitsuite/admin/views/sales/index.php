...
<script>
    $(document).ready(function () {
        oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=admin_url('sales/getSales' . ($warehouse_id ? '/' . $warehouse_id : '') .'?v=1'. ($this->input->get('sale_type') ? '&sale_type='.$this->input->get('sale_type') : ''). ($this->input->get('shop') ? '&shop='.$this->input->get('shop') : ''). ($this->input->get('attachment') ? '&attachment='.$this->input->get('attachment') : ''). ($this->input->get('delivery') ? '&delivery='.$this->input->get('delivery') : '')); ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                nRow.setAttribute('sale_type', <?=$this->input->get('sale_type');?>);
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                ...
                <?php if($sale_type==1){
                    echo lang('sales1') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';
                }else{
                    echo lang('sales2') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';
                }?>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?=admin_url('sales/add')."?sale_type={$sale_type}"?>">
...
<?php if ($Owner || $GP['bulk_actions']) {?>
    <div style="display: none;">
         <input type="hidden" name="sale_type" value="<?=$this->input->get('sale_type');?>" id="sale_type"/>
