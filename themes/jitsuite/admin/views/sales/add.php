...
<div class="box">
    <div class="box-header">
        <?php if($sale_type==1){?>
            <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_sale1'); ?></h2>
        <?php }else{?>
            <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_sale2'); ?></h2>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("sales/add?sale_type=".$sale_type, $attrib);
                if ($quote_id) {
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php
                                if($sale_type==1){
                                    $pst = array( 'paid' => lang('paid2'));
                                 ?>
                                    <script>
                                        localStorage.setItem('slsale_status','paid');
                                    </script>
                                <?php
                                }elseif($sale_type==2){
                                    $pst = array('due' => lang('due'), 'partial' => lang('partial'));
                                ?>
                                    <script>
                                        localStorage.setItem('slsale_status','due');
                                    </script>
                                    <?php
                                }
                        ...
                        if($sale_type==1) {
                            echo form_hidden('payment_status', 'paid');
                        }elseif($sale_type==2){
                            echo form_hidden('payment_status', 'due');
                        }
                        }
                        ?>
                        <div class="clearfix"></div>
                        ...
                        <input type="hidden" name="sale_type" id="sale_type" value="<?=$sale_type?>" required="required">
