                        ...
                        <?php } ?>
                            ...
                            <?PHP
                                if(!empty($_GET['sale_type'])){
                                    $url = 'sales/add/?sale_type='.$_GET['sale_type'];
                                    ?>
                                  <li>
                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <?php } ?>
                                <td style="width: 100px; text-align:center; vertical-align:middle;"><?= $this->sma->formatQuantity($row->unit_quantity).' '.$row->unit_name; ?></td>
                                <?php
                                if ($Settings->product_serial) {
        ...
        <?php if (!$Supplier || !$Customer) { ?>
            <div class="buttons">
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <a href="<?= admin_url('sales/edit/' . $inv->id.'?sale_type='.$sale_type) ?>" class="tip btn btn-warning tip sledit" title="<?= lang('edit') ?>">
                    ...
                    <div class="btn-group">
                        <a href="#" class="tip btn btn-danger bpo"
                            ...
                            data-content="<div style='width:150px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?= admin_url('sales/delete/' . $inv->id.'?sale_type='.$sale_type) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>"
