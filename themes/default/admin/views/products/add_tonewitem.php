...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            source: '<?= admin_url('products/qa_suggestions_tonewItem/'); ?>'+$('#qawarehouse').val(),
            minLength: 1,
            autoFocus: false,
            delay: 250,
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_tonewitem'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("products/add_tonewitem", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin) { ?>
                        ...
                        <div class="col-md-12">
                            <div
                                class="fprom-group"><?php echo form_submit('add_tonewitem', lang("submit"), 'id="add_tonewitem" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
