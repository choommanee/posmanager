                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="products_quantity_tonewitem">
                                        <a class="submenu" href="<?= admin_url('products/quantity_tonewitem'); ?>">
                                            <i class="fa fa-filter"></i>
                                            <span class="text"> <?= lang('quantity_tonewitem'); ?></span>
                                        </a>
                                    </li>
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul>
                                    ...
                                    <li id="sales_index1">
                                        <a class="submenu" href="<?= admin_url('sales')."?sale_type=1"; ?>">
                                            <i class="fa fa-heart"></i>
                                            <span class="text"> <?= lang('list_sales'); ?></span>
                                        </a>
                                    </li>
                                    <li id="sales_index2">
                                        <a class="submenu" href="<?= admin_url('sales')."?sale_type=2"; ?>">
                                            <i class="fa fa-heart"></i>
                                            <span class="text"> <?= lang('list_sales2'); ?></span>
                                        </a>
                                    </li>
                                   <!-- <li id="sales_add">
                                ...
                                <!--<li id="sales_sale_by_csv">
                                    ...
                                    <li id="sales_invoice">
                                        <a class="submenu" href="<?= admin_url('invoice'); ?>">
                                            <i class="fa fa-truck"></i>
                                            <span class="text"> <?= lang('invoices'); ?></span>
                                        </a>
                                    </li>
                                    <li id="sales_receipt">
                                        <a class="submenu" href="<?= admin_url('receipt'); ?>">
                                            <i class="fa fa-truck"></i>
                                            <span class="text"> รับชำระหนี้ (ออกใบเสร็จรับเงิน)</span>
                                        </a>
                                    </li>
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <li id="reports_sales">
                                        <a href="<?= admin_url('reports/sales') ?>?sale_type=lc">
                                            <i class="fa fa-heart"></i><span class="text"> <?= lang('sales_report_lc'); ?></span>
                                        </a>
                                    </li>
                                    <li id="reports_sales">
                                        <a href="<?= admin_url('reports/sales') ?>?sale_type=lv">
                                            <i class="fa fa-heart"></i><span class="text"> <?= lang('sales_report_lv'); ?></span>
                                        </a>
                                    </li>
                                    <li id="reports_sales">
                                        <a href="<?= admin_url('reports/sales') ?>?sale_type=pos">
                                            <i class="fa fa-heart"></i><span class="text"> <?= lang('sales_report_pos'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="reports_vatpayments">
                                        <a href="<?= admin_url('reports/vatpayments') ?>">
                                            <i class="fa fa-money"></i><span class="text"> <?= lang('vatpayments_report'); ?></span>
                                        </a>
                                    </li>
                                    <li id="reports_purchases">
                                        <a href="<?= admin_url('reports/vatpurchases') ?>">
                                            <i class="fa fa-star"></i><span class="text"> <?= lang('vatpurchases_report'); ?></span>
                                        </a>
                                    </li>
