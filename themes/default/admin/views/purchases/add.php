...
<script type="text/javascript">
    ...
    localStorage.setItem('potype_vat');
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <?php if ($Owner || $Admin || $GP['suppliers-add'] || $GP['suppliers-index']) { ?><div class="input-group"><?php } ?>
                                                <input type="text" name="supplier" value="" id="posupplier"
                        ...
                        <div class="panel panel-warning">
                            <div
                                    class="panel-heading">กรุณากรอกรายละเอียดการสั่งซื้อ</div>
                            <div class="panel-body" style="padding: 5px;">
                        <?php if ($Owner || $Admin) { ?>
                        ...
                        <div class="col-md-12">
                            <div class="control-group table-group">
                                <label class="table-label"><?= lang("order_items"); ?> <input type="checkbox" id="type_vat" name="type_vat" value="0" /></label>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row" id="extras-con" style="display: none;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?= lang("shipping_pay_type", "poshippingpaytype"); ?>
                                        <?php
                                        $tr = array("1"=>"บวกค่าขนส่งก่อน vat","2"=>"บวกค่าขนส่งหลัง Vat");

                                        echo form_dropdown('shipping_pay_type', $tr, "", 'id="shipping_pay_type" class="form-control input-tip select" style="width:100%;"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-md-4">
