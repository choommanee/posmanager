            ...
            <div class="table-responsive">
                <table class="table table-bordered" style="font-size: 10px;">
                    ...
                    <tr style="font-size: 10pt;">
                            ...
                            <th style="width:10%;"><?= lang("reference_no"); ?></th>
                            <th style="width:10%;">เลขที่ผู้เสียภาษี</th>
                            <th style="width:37%;"><?= lang("supplier"); ?></th>
                            <th style="width:15%;">จำนวนเงิน</th>
                            <th style="width:15%;">ภาษี</th>
                        </tr>
                    ...
                    foreach ($rows as $row):
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle;font-size: 8pt;text-align:right;">
                                <?= $this->sma->formatDecimalMoney($row->total_tax,2); ?>
                            </td>
                        ...
                        $totalTax = $totalTax+$row->total_tax;
                        $totalPerPageAmount = $totalPerPageAmount+$row->grand_total;
                        $totalTaxPerPage = $totalTaxPerPage+$row->total_tax;
                       // $k=$i;
                         if(($r%40)==0){
