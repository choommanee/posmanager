    ...
    function loadItems() {
        ...
        if (localStorage.getItem('positems')) {
            ...
            $.each(sortedItems, function () {
                ...
                tr_html += '<td class="text-right">' + formatMoney(((parseFloat(item_price)) * parseFloat(item_qty))) + '</td>';
            ...
            console.log('('+order_discount+'-'+product_discount+')');
            total_discount = formatDecimal((order_discount + product_discount)+0);
            console.log('('+total+'-'+order_discount+')-'+shipping);
            shipping = (isNaN(shipping))?0.00:shipping;
            var gtotal = parseFloat(((total) - order_discount)) + shipping;
          //  alert(gtotal);
