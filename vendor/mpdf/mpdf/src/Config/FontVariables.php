	...
	public function __construct()
	{
		$this->defaults = [
			...
			'sans_fonts' => ['dejavusanscondensed', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans', 'freesans', 'liberationsans',
				...
				'humanist777', 'humanist777black', 'humanist777light', 'futura', 'hobo', 'segoeprint','thsarabunnew','THSarabun'
			],
			...
			'serif_fonts' => ['dejavuserifcondensed', 'serif', 'dejavuserif', 'freeserif', 'liberationserif',
				...
				'norasi', 'charis', 'palatino', 'constantia', 'georgia', 'albertus', 'xbzar', 'algerian', 'garamond','thsarabunnew','THSarabun'
			],
